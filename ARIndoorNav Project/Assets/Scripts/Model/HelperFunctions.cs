...
public class HelperFunctions : MonoBehaviour
{
    ...
    public static Transform CalculateAverageTransfrom(List<Transform> transformList)
    {
        ...
        resultTransform.position = new Vector3(x / transformList.Count, y / transformList.Count, z / transformList.Count);
        resultTransform.rotation = AverageQuaternion(transformList);
